...
#slide-wrapper #slide-outer .slide .slide-inner {margin:0px;color:#fff;overflow:hidden;background:#000;height:<?php echo $height; ?>px;}
...
/* --- Navigation Buttons --- */
#pseudobox {position:absolute;top:7px;left:0;right:0;height:34px;margin:0;padding:0;background:#444;opacity:0.8;-moz-opacity:0.8;filter:alpha(opacity=80);width:<?php echo $sidebarWidth; ?>px;}
