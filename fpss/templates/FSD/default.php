		...
		<div id="navi-outer">
			<div id="pseudobox"></div>
				<div class="ul_container">
					<ul>
						<li class="noimages"><a id="fpss-container_prev" href="javascript:void(0);" onclick="showPrev();clearSlide();" title="<?php echo TEXT_PREVIOUS; ?>">&laquo;</a></li>
						<?php foreach($output as $k=>$slide): ?>
						<li>
							<a class="navbutton off navi" href="javascript:void(0);"<?php echo $slide->rotateAction; ?> title="<?php echo $slide->name; ?>">
								<span class="navbar-img"><img src="<?php echo $slide->thumbImage; ?>" alt="<?php echo TEXT_NAVIGATETO; ?> <?php echo $slide->altname; ?>" /></span>
                                <!--span class="navbar-key"><?php echo ltrim($slide->counter, '0'); ?></span-->
						...
						<?php endforeach; ?>
						<li class="noimages"><a id="fpss-container_next" href="javascript:void(0);" onclick="showNext();clearSlide();" title="<?php echo TEXT_NEXT; ?>">&raquo;</a></li>
